...
Each question has a **recommended default**. Answer inline under `**Answer:**`
(or simply reply "go with all defaults"). Once answered and you explicitly say
**"start development"**, Phase 1 of `ROADMAP.md` begins.
...
When you are happy with the answers above, please reply with an explicit
**"start development"** (or the phase you want first). Until then, nothing
beyond documentation is committed.
